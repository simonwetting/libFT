...
Resources:
	When I got stuck my peers helped me. Sometimes smaller questions could be asked to the AI, for example when pushing to git didn't work. And of course the LibFTTester from trippouile. I did write my own tests for all the functions. Though there were many cases that I forgot to check. But there were also cases that the LibFTtester didn't check for example the ft_strtrim.